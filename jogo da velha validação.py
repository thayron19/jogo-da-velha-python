...
def matrix():
    ...
    if um_var.get() != '' and linha1[0] == '0':
        linha1[0] = str(acumula) + um_var.get()

    if dois_var.get() != '' and linha2[0] == '0':
        linha2[0] = str(acumula) + dois_var.get()

    if tres_var.get() != '' and linha3[0] == '0':
        linha3[0] = str(acumula) + tres_var.get()

    if quatro_var.get() != '' and linha1[1] == '0':
        linha1[1] = str(acumula) + quatro_var.get()

    if cinco_var.get() != '' and linha2[1] == '0':
        linha2[1] = str(acumula) + cinco_var.get()

    if seis_var.get() != '' and linha3[1] == '0':
        linha3[1] = str(acumula) + seis_var.get()

    if sete_var.get() != '' and linha1[2] == '0':
        linha1[2] = str(acumula) + sete_var.get()

    if oito_var.get() != '' and linha2[2] == '0':
        linha2[2] = str(acumula) + oito_var.get()

    if nove_var.get() != '' and linha3[2] == '0':
        linha3[2] = str(acumula) + nove_var.get()
...
def maquina():  # inteligencia do jogo
    ...
    if cinco_var.get() == '':  # caso o jogador não escolha o centro no início
        ...
        if len(posicoes_impar) != 0:
            x = rd.choice(posicoes_impar)
        else:
            if len(posicoes_par) != 0:
    ...
    if (um_var.get() == 'X' and dois_var.get() == 'X' and tres_var.get() == 'X') or \
       (um_var.get() == 'O' and dois_var.get() == 'O' and tres_var.get() == 'O'):
        ...
        cinco_btn['bg'] = 'blue'
        seis_btn['bg'] = 'blue'
        placar(quatro_var.get())  # envia para o placar o vitorioso
        ...
        oito_btn['bg'] = 'blue'
        nove_btn['bg'] = 'blue'
        placar(sete_var.get())  # envia para o placar o vitorioso
    ...
    # vitórias nas linhas
        ...
        cinco_btn['bg'] = 'blue'
        oito_btn['bg'] = 'blue'
        placar(dois_var.get())  # envia para o placar o vitorioso
        ...
        seis_btn['bg'] = 'blue'
        nove_btn['bg'] = 'blue'
        placar(tres_var.get())  # envia para o placar o vitorioso
...
def placar(x):
    ...
    if x == 'X':
        vitorias_var.set(str(int(vitorias_var.get())+1))
        print('Rodada', acumula)
        print(linha1)
        print(linha2)
        print(linha3)
        breakpoint()
    elif x == 'O':
        derrotas_var.set(str(int(derrotas_var.get())+1))
        limpa()
    else:
...
# ---------------------------------------------------------------------------------------------------------------------
con_txt_btn = tk.Button(janela, text='Limpar', command=lambda: limpa())
con_txt_btn.place(x=130, y=10, width=50)
# ---------------------------------------------------------------------------------------------------------------------
...
nove_btn['bg'] = 'white'
# ---------------------------------------------------------------------------------------------------------------------
vi_txt = tk.Label(janela, text='Votórias:')
...
# ---------------------------------------------------------------------------------------------------------------------
vitorias_var = tk.StringVar()
vitorias_var.set('0')
vitorias_txt = tk.Label(janela, textvariable=vitorias_var)
...
# ---------------------------------------------------------------------------------------------------------------------
em_txt = tk.Label(janela, text='#', font=('', 40))
em_txt.place(x=140, y=220)
# ---------------------------------------------------------------------------------------------------------------------
kb.on_press_key('1', lambda _: teste())  # comando para recomeçar
